...
public class A_Array {
	 ...
	 * 		int [] arr = new int[3];
	 * 		int자료형 값을 저장할 수 있는 메모리 영역이 3칸 할당된다.
	 * 		[0,0,0]
	 * 		배열에 저장된 데이터를 꺼낼 때에는 인덱스를 활용하여 인덱스는 0부터 시작
	 * 		arr[0], arr[1], arr[2]
	 * 		배열의 크기가 5, 마지막 인덱스 4
	...
	public void method4() {
		...
		//System.out.println(arr[0]); // 배열값
		//System.out.println(str.equals("")); // method
		//System.out.println(arr.length); // field
		// 참조할 주소가 없어서 NullPointerException 오류 발생.
	...
	public void method5() {
		 ...
		 * => 배열의 크기를 변경하고자 한다면 새로운 배열을 생성해야한다.
		 *
		 */
		arr = new int[6];
		
		arr = null; // 참조형 변수에 null값을 대입하면, 가비지 컬렉터
					// 가 해당 메모리를 즉시 삭제시켜준다.
