...
public class B_Cast {
	 ...
	 * 
	 * 컴퓨터의 값 처리 규칙
	 * 1. 값 끼리의 연산은 같은 자료형으로만 연산 가능
	 *    =(대입 연산자)도 마찬가지로 왼쪽과 오른쪽의 자료형이 같아야한다.
	 *    자료형 변수명 = 값;
	...
	public void autoCasting() {
		...
		long l4 = /*(long)*/ 2000;
		// 다만 너무 큰 리터럴 값을 사용해야 하는 경우 1을 붙여줌.
		...
		int num = '민'; // 한글과 같은 기타나라의 언어는 유니코드표 (0~65536)에 기술되어 있다.
	...
	float f1 = 4.0F;
	float f2 = (float)4.0;
	float f3 = (float)d1; //float f3 = d1f; 변수에는 뒤에 f붙이는 게 불가능함.
