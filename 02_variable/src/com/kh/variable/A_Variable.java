...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("시급 : 10000");
		System.out.println("근무시간 : 6");
		System.out.println("근무일수 : 5");
		
		System.out.println("안정현 : " + 10000 * 6 * 5 + "원");
		System.out.println("안정현2 : " + 8500 * 6 * 5 + "원");
		System.out.println("안정현3 : " + 8500 * 6 * 5 + "원");
		System.out.println("안정현4 : " + 8500 * 6 * 5 + "원");
		System.out.println("안정현5 : " + 8500 * 6 * 5 + "원");		
		...
		System.out.println("안정현 : " + pay * time * day + "원");
	...
	public void dclareVariable() {
		 ...
		 * ex) String userName => 이어쓰기한 단어의 첫글자를 대문자로 바꿈
		 * 
		 * 주의점
