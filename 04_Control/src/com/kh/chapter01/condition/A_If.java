...
public class A_If {
	...
	public void method4() {
		...
		// 어린이 (13세 이하), 청소년 (31세 초과 19세 이하),
		// 성인 (19세 초과 60세 이하) / 어르신 (60세 이상)
		...
		if(age <= 13) {
			int a = 0; // if문 안에서 선언한 변수는 if문 안에서만 쓸 수 있음.
			System.out.println("어린이");
		}else if(age <= 19) {
				System.out.println("청소년");
		}else if (age <= 60) {
